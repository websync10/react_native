...
const CardWithModals = ({ image, title, date, isPublic, people }: any) => {
  const [manageVisible, setManageVisible] = React.useState(false);
  const [deleteVisible, setDeleteVisible] = React.useState(false);
  const router = useRouter();

  return (
    <TouchableOpacity style={styles.card} activeOpacity={0.85} onPress={() => router.push('/pages/mylookDetails')}>
      <View style={styles.imageWrapper}>
        ...
        {/* ...existing code for people avatars... */}
      </View>
      ...
      >
        <View style={styles.modalOverlay}>
          <View style={styles.modalContainer}>
            ...
            <TouchableOpacity style={styles.deleteButton} onPress={() => { setManageVisible(false); setDeleteVisible(true); }}>
